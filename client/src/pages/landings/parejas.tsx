...
const TRIAL_URL = "/register?audience=parejas";
...
export default function ParejasLanding() {
    ...
    <main className="landing-scope min-h-screen text-foreground" style={{ background: "var(--background-deep)" }}>
      ...
      >
        <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
          ...
          <CTA href={TRIAL_URL} testId="cta-parejas-header">Probar gratis</CTA>
        </header>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-6 pb-20 pt-10 md:grid-cols-2 md:items-center md:pb-28 md:pt-16">
          <div>
            ...
            <h1 className="mt-6 text-4xl font-bold leading-[1.05] tracking-tight md:text-6xl">
              Controlá tus finanzas y las de tu pareja{" "}
              <span
                style={{
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground md:text-xl">
              Ingresos, gastos y reportes con claridad. Organizá tu plata{" "}
              <span className="font-semibold text-foreground">y la de tu pareja</span> sin planillas ni vueltas.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <CTA href={TRIAL_URL} testId="cta-parejas-hero">Probar gratis →</CTA>
            </div>
            <p className="mt-4 text-sm text-muted-foreground">
              Plan Personal Pro · Listo en minutos.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-6 text-3xl font-bold tracking-tight md:text-5xl">
              Tus finanzas personales y las compartidas,{" "}
              <span
                style={{
                  backgroundImage: "var(--gradient-brand)",
                  WebkitBackgroundClip: "text",
            ...
            <p className="mt-5 text-lg text-muted-foreground">
              Gestioná tus cuentas y las de tu pareja por separado, y registrá movimientos en pesos o dólares, sin mezclar números ni perder de vista nada.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur">
              ...
              <p className="mt-3 text-muted-foreground">
                Manejá tus finanzas personales y las compartidas con tu pareja por separado, con reportes independientes para cada cuenta. Cambiá entre ellas en un clic.
              </p>
              <ul className="mt-5 space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2"><span style={{ color: "var(--brand-teal)" }}>✓</span> Cuentas personales y compartidas separadas</li>
      ...
      <section className="px-6 pb-20 pt-4">
        ...
        >
          ...
          <p className="mx-auto mt-5 max-w-xl text-lg text-muted-foreground">
            Centralizá tus ingresos y gastos, los tuyos y los de tu pareja. Decidí con datos reales, no con planillas sueltas.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <CTA href={TRIAL_URL} testId="cta-parejas-final">Probar gratis →</CTA>
          </div>
          <p className="mt-4 text-xs text-muted-foreground">
            Pensado para personas y parejas · Cancelás cuando quieras
          </p>
        </div>
      </section>
